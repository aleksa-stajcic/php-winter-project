			...
			<div class="col-lg-12">
				<div class="new_arrival_iner filter-container">
					<div class="single_arrivel_item weidth_1 mix shoes">
						<img src="app/assets/img/arrivel/arrivel_5.png" alt="#">
						<div class="hover_text">
							<p>Canvas</p>
					...
					<div class="single_arrivel_item weidth_2 mix women">
						<img src="app/assets/img/arrivel/arrivel_2.png" alt="#">
						<div class="hover_text">
							<p>Canvas</p>
							<a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
							<div class="rate_icon">
					...
					<div class="single_arrivel_item weidth_3 mix shoes women" >
						<img src="app/assets/img/arrivel/arrivel_3.png" alt="#">
						<div class="hover_text">
							<p>Canvas</p>
							<a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
							<div class="rate_icon">
					...
					<div class="single_arrivel_item weidth_3 mix women men">
						<img src="app/assets/img/arrivel/arrivel_4.png" alt="#">
						<div class="hover_text">
							<p>Canvas</p>
							<a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
							<div class="rate_icon">
					...
					<div class="single_arrivel_item weidth_2 mix men women">
						<img src="app/assets/img/arrivel/arrivel_1.png" alt="#">
						<div class="hover_text">
							<p>Canvas</p>
							<a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
							<div class="rate_icon">
					...
					<div class="single_arrivel_item weidth_1 mix shoes men">
						<img src="app/assets/img/arrivel/arrivel_6.png" alt="#">
						<div class="hover_text">
							<p>Canvas</p>
							<a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
							<div class="rate_icon">
		...
		<div class="row">
			<div class="col-lg-3 col-sm-6">
				<div class="single_shopping_details">
					<img src="app/assets/img/icon/icon_1.png" alt="">
					<h4>Free shipping</h4>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="single_shopping_details">
					<img src="app/assets/img/icon/icon_2.png" alt="">
					<h4>Free shipping</h4>
					<p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6">
				<div class="single_shopping_details">
					<img src="app/assets/img/icon/icon_3.png" alt="">
					<h4>Free shipping</h4>
					<p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6">
				<div class="single_shopping_details">
					<img src="app/assets/img/icon/icon_4.png" alt="">
					<h4>Free shipping</h4>
					<p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
				</div>
			</div>
